 ...
 */
public class NotionExternalTaskActuals extends ExternalTaskActuals {
    ...
    public NotionExternalTaskActuals(double actualEffort, double percentComplete, Date scheduledStart, Date scheduledFinish, Long resourceId) {
